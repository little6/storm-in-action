...
public class AllBolt1 extends BaseBasicBolt
{
    ...
    private final static Logger LOG = LoggerFactory.getLogger(AllBolt1.class);
    ...
    public void execute(Tuple input, BasicOutputCollector collector)
    {
        ...
        LOG.warn("AllBolt1->execute:hashcode:{},taskID:{},RESULT:{}", this.hashCode(), context.getThisTaskId(), name);
    }
